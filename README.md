...
| 04th Jan | [1009. Complement of Base 10 Integer](https://leetcode.com/problems/complement-of-base-10-integer/) | `Bit Manipulation` | 💚 |
| 05th Jan | [131. Palindrome Partitioning](https://leetcode.com/problems/palindrome-partitioning/) | `String` `Dynamic Programming` `Backtracking`| 🧡 |
| 06th Jan | [1094. Car Pooling](https://leetcode.com/problems/car-pooling/) | `Array` `Sorting` `Heap(Priority Queue)` `Simulation` `Prefix Sum` | 🧡 |
| 07th Jan | [382. Linked List Random Node](https://leetcode.com/problems/linked-list-random-node/) | `Linked List` `Math` `Reservoir Sampling` `Randomized` | 🧡 |
...
| 29th Sep | [658. Find K Closest Elements](https://leetcode.com/problems/find-k-closest-elements/) | `Array` `Two Pointers` `Binary Search` `Sorting` `Heap (Priority Queue)` | 🧡 |
| 30th Sep | [218. The Skyline Problem](https://leetcode.com/problems/the-skyline-problem/) | `Array` `Divide and Conquer` `Binary Indexed Tree` `Segment Tree` `Line Sweep` `Heap (Priority Queue)` `Ordered Set` | ❤️ |
...
| 16th Jan | [57. Insert Interval](https://leetcode.com/problems/insert-interval/) | `Array` | 🧡 |
